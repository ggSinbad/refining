...
ProbabilityCalculator2 <- function(Level, Enriched){ #Enriched should be TRUE or FALSE, Level should be the level of refine you currently are.
...
for (i in 1:9){
  ...
  print(ProbabilityCalculator2(i, FALSE))
